...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_name', type=str, required=True)
    parser.add_argument('--datadir', type=str, required=True, help='source dataset dir')
    ...
    parser.add_argument(
        "--benchmark",
        default="ImageReward-v1.0, CLIP, PickScore, HPS, FID",
        type=str,
        help="Comma-separated metrics: ImageReward-v1.0, CLIP, PickScore, HPS, FID.",
    )
    ...
    if 'FID' in benchmark_types:
        ...
        fid_value = fid_score.calculate_fid_given_paths([gen_path, real_path], 50, 'cuda', 2048).item()
        benchmark_results['FID'] = fid_value
